        ...
        <section className='portfolio section section_narrow_sides'>
            ...
            <ul className='portfolio__list'>
                <li className='portfolio__item'>
                    <a href='https://kkulumbegova.github.io/russian-travel/' className='portfolio__link' target='__blank'><p className='portfolio__title'>Статичный сайт</p></a>
                ...
                <li className='portfolio__item'>
                    <a href='https://kkulumbegova.github.io/russian-travel/' className='portfolio__link' target='__blank'><p className='portfolio__title'>Адаптивный сайт</p></a>
                    <a href='https://kkulumbegova.github.io/russian-travel/' className='portfolio__link' target='__blank'><img alt='Ссылка' src={linkIcon} className='link__arrow'/></a>
                </li>
                <li className='portfolio__item'>
                    <a href='https://kulumbegova.mesto.nomorepartiesxyz.ru/' className='portfolio__link' target='__blank'><p className='portfolio__title'>Одностраничное приложение</p></a>
